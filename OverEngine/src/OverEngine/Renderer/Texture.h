...
namespace OverEngine
{
	...
	public:
		static Ref<Texture> Create(const Ref<Texture2D>& texture, const Rect& rect);
	...
	private:
		...
		struct InternalSubTexture2DData
		{
			Ref<Texture2D> m_MasterTexture;
			Rect m_Rect;
		};

		std::optional<InternalSubTexture2DData> m_Data;
	};
}
